...
/turf/simulated/wall/mineral/concrete
	name = "concrete wall"
	desc = "A wall with concrate panels. Tough and rough."
	icon_state = "concrete0"
	walltype = "concrete"
	mineral = "concrete"

	attackby(obj/item/weapon/W as obj, mob/user as mob)
		var/list/capable_of_penetrating = list(/obj/item/weapon/pickaxe/jackhammer,
