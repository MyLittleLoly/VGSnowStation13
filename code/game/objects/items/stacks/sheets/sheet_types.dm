...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	...
	new/datum/stack_recipe("Campfire", /obj/machinery/campfire, 2, time = 10, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("wooden wall", /obj/structure/woodenwalls, 3, time = 10, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("wooden floor", /obj/structure/woodfloor, 2, time = 10, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("wooden window", /obj/structure/barricade/window, 3, time = 10, one_per_turf = 1, on_floor = 1), \
	)
