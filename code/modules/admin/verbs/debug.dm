...
/* STAR WARS UNITS******************************* */
		...
		if("Rebel pilot")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/head/rebel_pilot_helm(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rebel_pilot(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(M), slot_gloves)
		...
		if("Han Solo")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/tie/holster/armpit(M), slot_l_hand)
...
/*
		if ("Jedi Knight")
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/melee/energy/sword/green(M), slot_l_hand)
		...
		if ("Sith")
			...
			M.equip_to_slot_or_del(new /obj/item/weapon/melee/energy/sword/red(M), slot_l_hand)
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/captain(M), slot_ears)
			var/obj/item/device/pda/heads/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "Imperial SpecOps"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
		...
		if ("Lord Sith")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/color/grey(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/lord_sith(M), slot_wear_suit)
		//	M.equip_to_slot_or_del(new /obj/item/clothing/head/sith_hood(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/weapon/melee/energy/sword/red(M), slot_l_hand)
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/captain(M), slot_ears)
			var/obj/item/device/pda/heads/pda = new(M)
...
*/
		if ("Lord Vader")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/clown_shoes(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/color/grey(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/darth_vader(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/darth_vader_helm(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/weapon/melee/energy/sword/red(M), slot_l_hand)
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/captain(M), slot_ears)
			var/obj/item/device/pda/heads/pda = new(M)
			pda.owner = M.real_name
