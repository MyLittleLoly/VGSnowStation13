/obj/item/weapon/gun
	...
	var/alt_fire = 0
	var/obj/item/device/flashlight/gun/flashlight
...
/obj/item/weapon/gun/proc/AltFire(atom/target as mob|obj|turf|area, mob/living/user as mob|obj)
	return


/obj/item/weapon/gun/proc/Fire(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, var/params = "", reflex = 0)//TODO: go over this
	...
	if(mouse_control["middle"] && alt_fire)
		return AltFire(target, user)
