...
/obj/item/weapon/reagent_containers/food/drinks/flask/survflask
	name = "emergency supply flask"
	desc = "For those who can't be bothered to stay at warm bar during a snow storm."
	icon_state = "survflask"
	volume = 60
	New()
		..()
